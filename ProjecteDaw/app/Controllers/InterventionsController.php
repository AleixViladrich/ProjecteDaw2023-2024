...
class InterventionsController extends BaseController
{
    ...
    public function addIntervention_post() {
        ...
        if ($this->validate($validationRules)) {
            ...
            session()->setFlashdata('success', 'intervencio afegida correctament');
            return redirect()->back()->withInput();
        } else {
            session()->setFlashdata('error', 'camp obligatori requerit');
            return redirect()->back()->withInput();
        }
    }
    ...
    public function updateIntervention($idInter) {
        ...
        // variables per diferents comprovacions
        $block = false;
        $stockNull = false;
        if ($stock != null) {
    ...
    public function updateIntervention_post($idInter) {
        ...
        if ($this->validate($validationRules)) {
            ...
            $instanceT->update(session()->getFlashdata("idTicket"), $data);*/
            session()->setFlashdata('success', 'intervencio modificada correctament');
            return redirect()->back()->withInput();
        } else {
            session()->setFlashdata('error', 'camp obligatori requerit');
            return redirect()->back()->withInput();
