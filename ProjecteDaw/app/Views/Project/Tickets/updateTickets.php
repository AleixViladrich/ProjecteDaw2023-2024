...
<div class="container-fluid mt-3">
    <div id="centres" class="border">
        ...
        <form action="<?php base_url("/updateTicket/" . $ticket['ticket_id']) ?>" method="POST" class="formAdd p-2 pb-0">
            ...
            <div class="row">
                ...
                <?php endif; ?>
                <div class="form-group col-6 my-4 ">
                    <label for="status" class=" bold fs-5">Status</label>
...
<script>
    $(document).ready(function() {
        ...
        var change = <?php echo json_encode($statusChange); ?>;
